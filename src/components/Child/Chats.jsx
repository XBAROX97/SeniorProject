    ...
    {Object.entries(chats)
      ...
      .map((chat) => (
        <div
          ...
          className='flex gap-2 border-t hover:bg-blue-200 transform motion-safe:hover:scale-110   bg-gray-50 border-gray-300 transition-all duration-100 cursor-pointer select-none px-4 py-2'
        >
